...
import { ProjectBadge, type ProjectStatus } from '@/src/components/UI/featuredProjects/ProjectBadge';
import {
  ArrowLeftIcon,
  ArrowUpRightIcon,
  CheckCircleIcon,
              ...
              <div className="space-y-8">
                {projectText.map((item, index) => (
                  <div key={index}>
                    ...
                    <p className="text-lg leading-relaxed text-primary-grey">
                      {item.desc}
                    </p>
                  </div>
                ))}
              ...
              <div>
                ...
                <ul className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  {project.features.map((feature: string) => (
                    <li key={feature} className="flex items-start gap-3 text-primary-grey">
                      <CheckCircleIcon
                        size={20}
